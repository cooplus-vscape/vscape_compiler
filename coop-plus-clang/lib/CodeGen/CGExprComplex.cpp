...
void CodeGenFunction::EmitStoreOfComplex(ComplexPairTy V, LValue dest,
                                         bool isInit) {
  if (this->dumpVirtual & dest.isFieldAccess()) // chao
  {
    this->vfss << "\t\t<access>\n";
    this->vfss << "\t\t\t<type>" << "Write" << "</type>\n";
    this->vfss << "\t\t\t<depth>" << dest.getFieldAccessDepth() << "</depth>\n";;
    this->vfss << "\t\t\t<offset>" << dest.getFieldOffset() << "</offset>\n";
    this->vfss << "\t\t\t<clang>" << "CodeGenFunction::EmitStoreOfComplex" << "</clang>\n";
    this->vfss << "\t\t</access>\n";
  }
...
ComplexPairTy CodeGenFunction::EmitLoadOfComplex(LValue src,
                                                 SourceLocation loc) {
  if (this->dumpVirtual & src.isFieldAccess()) // chao
  {
    this->vfss << "\t\t<access>\n";
    this->vfss << "\t\t\t<type>" << "Read" << "</type>\n";
    this->vfss << "\t\t\t<depth>" << src.getFieldAccessDepth() << "</depth>\n";;
    this->vfss << "\t\t\t<offset>" << src.getFieldOffset() << "</offset>\n";
    this->vfss << "\t\t\t<clang>" << "CodeGenFunction::EmitLoadOfComplex" << "</clang>\n";
    this->vfss << "\t\t</access>\n";
  }
