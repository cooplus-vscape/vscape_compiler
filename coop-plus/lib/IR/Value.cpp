...
void Value::setFieldAccess(int64_t offset, unsigned depth /*= 1*/) {
  if(structField.fieldAccessDepth)
  {
    // abort compilation
    llvm_unreachable("ERROR: Value::setFieldAccess twice.\n");
  }
  structField.fieldAccessDepth = depth;
  structField.fieldAccessOffset = offset;
}
bool Value::isFieldAccess() {
  return structField.fieldAccessDepth > 0;
}
unsigned Value::getFieldAccessDepth() {
  return structField.fieldAccessDepth;
}
void Value::increaseFieldAccessDepth() {
  structField.fieldAccessDepth++;
}
int64_t Value::getFieldOffset(){
  return structField.fieldAccessOffset;
}
